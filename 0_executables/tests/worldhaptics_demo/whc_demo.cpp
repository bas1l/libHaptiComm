...
int main(int argc, char *argv[])
{
    ...
    ***************************************************************************/
    ...
    TAP_MOVE_DURATION = atoi(argv[1]);
    APPARENT_ASC_DURATION = atoi(argv[2]);
    APPARENT_MOVE_DURATION = atoi(argv[3]);
    APPARENT_MOVE_AMPLITUDE = atoi(argv[4]);
    APPARENT_NB_ACT_SUPERPOSED = atoi(argv[5]);
